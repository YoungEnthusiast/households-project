...
class CustomRegisterFormQwikAdmin(UserChangeForm):
    ...
    class Meta:
        model = Person
        fields = ['first_name', 'last_name', 'email', 'username', 'phone_number', 'holding', 'subscription', 'dob', 'gender', 'state', 'city', 'lg', 'outlet', 'type', 'about_me', 'address', 'outlet', 'photograph', 'referrer']
