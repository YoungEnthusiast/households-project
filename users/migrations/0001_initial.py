    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holding', models.CharField(blank=True, max_length=110, null=True, verbose_name='Possession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated', models.DateTimeField(auto_now=True, null=True)),
                ('manager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='outlet_manager', to=settings.AUTH_USER_MODEL, verbose_name='QwikVendor')),
